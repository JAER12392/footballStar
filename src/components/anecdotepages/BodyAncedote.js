...
const BodyAncedote = () => (
    <div>
      <p className="first-story-body">This is the beginning life, especially for my parents
      Roberto Esquivvel and Blanca Ramos. Their lives forever changed by a miracle from god.
